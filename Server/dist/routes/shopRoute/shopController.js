...
const httpGetStoreData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const storeData = yield storeItemsModel_1.default.find({}, { _id: 0, __v: 0, 'items._id': 0, 'items.__v': 0 }).sort({ id: 1 });
    if (!storeData) {
        return res
            .status(501)
